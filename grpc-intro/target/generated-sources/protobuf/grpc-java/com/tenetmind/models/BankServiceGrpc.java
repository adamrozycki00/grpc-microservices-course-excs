...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.tenetmind.models.BalanceCheckRequest,
      com.tenetmind.models.BalanceResponse> getGetBalanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getBalance",
      requestType = com.tenetmind.models.BalanceCheckRequest.class,
      responseType = com.tenetmind.models.BalanceResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.tenetmind.models.BalanceCheckRequest,
      com.tenetmind.models.BalanceResponse> getGetBalanceMethod() {
    io.grpc.MethodDescriptor<com.tenetmind.models.BalanceCheckRequest, com.tenetmind.models.BalanceResponse> getGetBalanceMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getGetBalanceMethod = BankServiceGrpc.getGetBalanceMethod) == null) {
          BankServiceGrpc.getGetBalanceMethod = getGetBalanceMethod =
              io.grpc.MethodDescriptor.<com.tenetmind.models.BalanceCheckRequest, com.tenetmind.models.BalanceResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getBalance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tenetmind.models.BalanceCheckRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.tenetmind.models.WithdrawRequest,
      com.tenetmind.models.MoneyResponse> getWithdrawMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "withdraw",
      requestType = com.tenetmind.models.WithdrawRequest.class,
      responseType = com.tenetmind.models.MoneyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.tenetmind.models.WithdrawRequest,
      com.tenetmind.models.MoneyResponse> getWithdrawMethod() {
    io.grpc.MethodDescriptor<com.tenetmind.models.WithdrawRequest, com.tenetmind.models.MoneyResponse> getWithdrawMethod;
    if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
          BankServiceGrpc.getWithdrawMethod = getWithdrawMethod =
              io.grpc.MethodDescriptor.<com.tenetmind.models.WithdrawRequest, com.tenetmind.models.MoneyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "withdraw"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tenetmind.models.WithdrawRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tenetmind.models.MoneyResponse.getDefaultInstance()))
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getBalance(com.tenetmind.models.BalanceCheckRequest request,
    ...
    /**
     */
    public void withdraw(com.tenetmind.models.WithdrawRequest request,
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.tenetmind.models.BalanceCheckRequest,
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BankServiceBlockingStub> {
    ...
    /**
     */
    public com.tenetmind.models.BalanceResponse getBalance(com.tenetmind.models.BalanceCheckRequest request) {
    ...
    /**
     */
    public java.util.Iterator<com.tenetmind.models.MoneyResponse> withdraw(
        com.tenetmind.models.WithdrawRequest request) {
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BankServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.tenetmind.models.BalanceResponse> getBalance(
        com.tenetmind.models.BalanceCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BALANCE:
          serviceImpl.getBalance((com.tenetmind.models.BalanceCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.tenetmind.models.BalanceResponse>) responseObserver);
          break;
        case METHODID_WITHDRAW:
          serviceImpl.withdraw((com.tenetmind.models.WithdrawRequest) request,
              (io.grpc.stub.StreamObserver<com.tenetmind.models.MoneyResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.tenetmind.models.BankServiceOuterClass.getDescriptor();
    }
